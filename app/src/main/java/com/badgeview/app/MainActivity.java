...
public class MainActivity extends AppCompatActivity {
    ...
    private void initBadge() {
        ...
        badges.add(new BadgeView(this).bindTarget(textview).setBadgeNumber(5));
        badges.add(new BadgeView(this).bindTarget(imageview).setBadgeText("PNG").setBadgeTextColor(0x00000000)
        ...
        badges.add(new BadgeView(this).bindTarget(button).setBadgeText("新").setBadgeTextSize(13, true)
